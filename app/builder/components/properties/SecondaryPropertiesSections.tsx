          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {dataGridProps.columns.map((col: any, idx: number) => (
                <div
                  key={idx}
                  className="rounded border border-gray-100 p-2 space-y-2"
                >
                  <div className="flex items-center gap-1">
                    <Input
                      ...
                      onChange={(e) =>
                        updateDataGridColumn(idx, "headerName", e.target.value)
                      }
                    />
                    <button
                      onClick={() => removeDataGridColumn(idx)}
                      className="text-red-400 hover:text-red-600"
                    >
                      <Trash2 size={14} />
                    </button>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        value={col.field}
                        onChange={(e) =>
                          updateDataGridColumn(idx, "field", e.target.value)
                        }
                      />
                    </div>
                    <div className="space-y-1">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("height", Number(e.target.value) || 320)
                }
              />
            </div>
          </div>
            ...
            <>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  minRows={2}
                  value={
                    Array.isArray(localProps.labels)
                      ? localProps.labels.join(", ")
                      : ""
                  }
                  onChange={(e) =>
                    handleChange("labels", parseCsvLabels(e.target.value))
                  }
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  minRows={2}
                  value={
                    Array.isArray(localProps.values)
                      ? localProps.values.join(", ")
                      : ""
                  }
                  onChange={(e) =>
                    handleChange("values", parseCsvNumbers(e.target.value))
                  }
              ...
              <div className="space-y-2">
                ...
                {(Array.isArray(localProps.labels)
                  ...
                  >
                    <div
                      className="w-24 text-[11px] text-gray-500 truncate"
                      title={label || `Item ${idx + 1}`}
                    >
                      {label || `Item ${idx + 1}`}
                    </div>
                    <input
                      type="color"
                      value={
                        getChartPointColors()[idx] ||
                        localProps.color ||
                        "#1976d2"
                      }
                      onChange={(e) =>
                        updateChartPointColor(idx, e.target.value)
                      }
          ...
          {localProps.chartType === "pie" && (
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("pieInnerRadius", Number(e.target.value) || 0)
                }
              />
            </div>
          )}
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleNodeStyleChange("color", e.target.value)
                  }
                  className="h-8 w-12 rounded border border-gray-300 bg-white p-1 cursor-pointer"
                />
                <Input
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("value", Number(e.target.value || 0))
                }
              />
            </div>
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("max", Math.max(1, Number(e.target.value || 1)))
                }
              />
            </div>
          </div>
